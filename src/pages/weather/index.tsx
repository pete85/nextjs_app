...
const WeatherPage: React.FC<WeatherPageProps> = ({weatherData, windImage, temperatureOption, windOption, windDirectionOption}) => {
    const {location, current} = weatherData;

    // Ensure options are defined before rendering charts
    if (!temperatureOption || !windOption || !windDirectionOption) {
...
export const getServerSideProps: GetServerSideProps = async () => {
    ...
    try {
        ...
        console.log('**************');
        // console.log('windDirOption: ', windDirOption);
